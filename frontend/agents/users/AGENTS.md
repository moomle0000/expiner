...
- `src/components/dashboard/ProfilePanel.tsx` — Self-service: edit name/email, change password, read-only account facts. Used by both admin and user profile pages.
...
- `PATCH  /api/auth/me` — `ENDPOINTS.me` (self name/email)
